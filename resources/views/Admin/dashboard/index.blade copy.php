...
<!-- Mirrored from coderthemes.com/konrix/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Jun 2024 08:36:49 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
        ...
        <div class="app-menu">
            ...
            <a href="index.html" class="logo-box">
                ...
                <div class="logo-light">
                    <img src="{{asset('asdzxc/images/logo-light.png')}}" class="logo-lg h-6" alt="Light logo">
                    <img src="{{asset('asdzxc/images/logo-sm.png')}}" class="logo-sm" alt="Small logo">
                </div>

                <!-- Dark Brand Logo -->
                <div class="logo-dark">
                    <img src="{{asset('asdzxc/images/logo-dark.png')}}" class="logo-lg h-6" alt="Dark logo">
                    <img src="{{asset('asdzxc/images/logo-sm.png')}}" class="logo-sm" alt="Small logo">
                </div>
            </a>
            ...
            <header class="app-header flex items-center px-4 gap-3">
                ...
                <div class="relative">
                    <button data-fc-type="dropdown" data-fc-placement="bottom-end" type="button" class="nav-link p-2 fc-dropdown">
                        <span class="flex items-center justify-center h-6 w-6">
                            <img src="{{asset('asdzxc/images/flags/us.jpg')}}" alt="user-image" class="h-4 w-6">
                        </span>
                    </button>
                    <div class="fc-dropdown fc-dropdown-open:opacity-100 hidden opacity-0 w-40 z-50 mt-2 transition-[margin,opacity] duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 rounded-lg p-2">
                        ...
                        <a href="javascript:void(0);" class="flex items-center gap-2.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                            <img src="{{asset('asdzxc/images/flags/germany.jpg')}}" alt="user-image" class="h-4">
                            <span class="align-middle">German</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="flex items-center gap-2.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                            <img src="{{asset('asdzxc/images/flags/italy.jpg')}}" alt="user-image" class="h-4">
                            <span class="align-middle">Italian</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="flex items-center gap-2.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                            <img src="{{asset('asdzxc/images/flags/spain.jpg')}}" alt="user-image" class="h-4">
                            <span class="align-middle">Spanish</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="flex items-center gap-2.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                            <img src="{{asset('asdzxc/images/flags/russia.jpg')}}" alt="user-image" class="h-4">
                        ...
                        <div class="p-4 h-80" data-simplebar>
                            ...
                            <a href="javascript:void(0);" class="block mb-4">
                                <div class="card-body">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{asset('asdzxc/images/users/avatar-2.jpg')}}" class="rounded-full h-9 w-9" alt="">
                                        </div>
                                        <div class="flex-grow truncate ms-2">
                            ...
                            <a href="javascript:void(0);" class="block">
                                <div class="card-body">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{asset('asdzxc/images/users/avatar-4.jpg')}}" class="rounded-full h-9 w-9" alt="">
                                        </div>
                                        <div class="flex-grow truncate ms-2">
                ...
                <div class="relative">
                    <button data-fc-type="dropdown" data-fc-placement="bottom-end" type="button" class="nav-link">
                        <img src="{{asset('asdzxc/images/users/user-6.jpg')}}" alt="user-image" class="rounded-full h-10">
                    </button>
                                    ...
                                    <div class="flex items-end">
                                        ...
                                        <div class="flex">
                                            <a href="javascript:void(0);">
                                                <img src="{{asset('asdzxc/images/users/avatar-1.jpg')}}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                            </a>
                                            <a href="javascript:void(0);" class="-ms-2">
                                                <img src="{{asset('asdzxc/images/users/avatar-2.jpg')}}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="p-6">
                                    ...
                                    <div class="flex items-end">
                                        ...
                                        <div class="flex">
                                            <a href="javascript:void(0);">
                                                <img src="{{asset('asdzxc/images/users/avatar-3.jpg')}}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                            </a>
                                            <a href="javascript:void(0);" class="-ms-2">
                                                <img src="{{asset('asdzxc/images/users/avatar-4.jpg')}}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="p-6">
                                    ...
                                    <div class="flex items-end">
                                        ...
                                        <div class="flex">
                                            <a href="javascript:void(0);">
                                                <img src="{{asset('asdzxc/images/users/avatar-5.jpg')}}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                            </a>
                                            <a href="javascript:void(0);" class="-ms-2">
                                                <img src="{{asset('asdzxc/images/users/avatar-6.jpg')}}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="p-6">
                                    ...
                                    <div class="flex items-end">
                                        ...
                                        <div class="flex">
                                            <a href="javascript:void(0);">
                                                <img src="{{asset('asdzxc/images/users/avatar-7.jpg')}}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                            </a>
                                            <a href="javascript:void(0);" class="-ms-2">
                                                <img src="{{asset('asdzxc/images/users/avatar-8.jpg')}}" class="rounded-full h-8 w-8 border-2 border-gray-300 dark:border-gray-700" alt="friend">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="py-6">
                                <div class="px-6" data-simplebar style="max-height: 304px;">
                                    <div class="space-y-6">
                                        <div class="flex items-center">
                                            <img class="me-3 rounded-full" src="{{asset('asdzxc/images/users/avatar-1.jpg')}}" width="40" alt="Generic placeholder image">
                                        ...
                                        <div class="flex items-center">
                                            <img class="me-3 rounded-full" src="{{asset('asdzxc/images/users/avatar-2.jpg')}}" width="40" alt="Generic placeholder image">
                                            <div class="w-full overflow-hidden">
                                        ...
                                        <div class="flex items-center">
                                            <img class="me-3 rounded-full" src="{{asset('asdzxc/images/users/avatar-3.jpg')}}" width="40" alt="Generic placeholder image">
                                            <div class="w-full overflow-hidden">
                                        ...
                                        <div class="flex items-center">
                                            <img class="me-3 rounded-full" src="{{asset('asdzxc/images/users/avatar-4.jpg')}}" width="40" alt="Generic placeholder image">
                                            <div class="w-full overflow-hidden">
                                        ...
                                        <div class="flex items-center">
                                            <img class="me-3 rounded-full" src="{{asset('asdzxc/images/users/avatar-5.jpg')}}" width="40" alt="Generic placeholder image">
                                            <div class="w-full overflow-hidden">
                                        ...
                                        <div class="flex items-center">
                                            <img class="me-3 rounded-full" src="{{asset('asdzxc/images/users/avatar-6.jpg')}}" width="40" alt="Generic placeholder image">
                                            <div class="w-full overflow-hidden">
    ...
    {{-- <script src="{{asset('asdzxc/libs/simplebar/simplebar.min.js')}}"></script> --}}
    {{-- <script src="{{asset('asdzxc/libs/feather-icons/feather.min')}}.js"></script> --}}
    {{-- <script src="assets/libs/%40frostui/tailwindcss/frostui.js"></script> --}}
    <script src="{{asset('asdzxc/libs/simplebar/simplebar.min.js')}}"></script>
    <script src="{{asset('asdzxc/libs/feather-icons/feather.min.js')}}"></script>
    <script src="{{asset('asdzxc/libs/%40frostui/tailwindcss/frostui.js')}}"></script>
    ...
    <script src="{{asset('asdzxc/libs/apexcharts/apexcharts.min.js')}}"></script>
    
    <!-- Dashboard Project Page js -->
    {{-- <script src="assets/js/pages/dashboard.js"></script> --}}
    <script src="{{asset('asdzxc/js/pages/dashboard.js')}}"></script>

</body>


<!-- Mirrored from coderthemes.com/konrix/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Jun 2024 08:37:16 GMT -->
</html>