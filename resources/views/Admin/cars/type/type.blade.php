                            ...
                            <div class="overflow-hidden">
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                        @foreach($CarsType as $row)
                                        <tr class="divide-x divide-gray-200 dark:divide-gray-700">
                                            <td class="py-1  text-center">{{$loop->iteration}}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{$row->id_cars_type}}</td>
                                            ...
                                            <td class="px-6 py-4 flex items-center justify-center gap-4">
                                                            ...
                                                            <div class="px-4 py-8 overflow-y-auto">
                                                                <div class="flex gap-10">
                                                                    ...
                                                                    <div class="flex-auto">
                                                                        ...
                                                                        <input type="hidden" name="id_type" value="{{$row->id_cars_type}}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="flex justify-end items-center gap-4 p-4 border-t dark:border-slate-700">
                                                ...
                                                <form action="{{route('delete_type', ['car' => $row->id_cars_type])}}" method="post">
                                                    @csrf
