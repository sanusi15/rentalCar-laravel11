...
<head>
    ...
    <!-- Gridjs Plugin css -->
    <link href="{{asset('asdzxc/libs/gridjs/theme/mermaid.min.css')}}" rel="stylesheet" type="text/css" >
    {{-- dropdone --}}
    <link href="{{asset('asdzxc/libs/dropzone/min/dropzone.min.css')}}" rel="stylesheet" type="text/css">
    {{-- nice select --}}
    <link href="{{asset('asdzxc/libs/nice-select2/css/nice-select2.css')}}" rel="stylesheet" type="text/css">
    <!-- glightbox css -->
    <link href="{{asset('asdzxc/libs/glightbox/css/glightbox.min.css')}}" rel="stylesheet">
...
<body>
                ...
                <ul class="menu" data-fc-type="accordion">
                    ...
                    <li class="menu-item">
                        <a href="/cars" class="menu-link">
                            <span class="menu-icon"><i class="mgc_car_3_line"></i></span>
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="sub-menu hidden">
                            <li class="menu-item">
                                <a href="{{route('cars_type')}}" class="menu-link">
                                    <span class="menu-text">Car Type</span>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{route('cars_model')}}" class="menu-link">
                                    <span class="menu-text">Car Model</span>
                                </a>
                            </li>
                            <li class="menu-item">
    ...
    <script src="{{asset('asdzxc/libs/apexcharts/apexcharts.min.js')}}"></script>
     <!-- Gridjs Plugin js -->
    <script src="{{asset('asdzxc/libs/gridjs/gridjs.umd.js')}}"></script>
    <script src="{{asset('asdzxc/js/pages/table-gridjs.js')}}"></script>
    <!-- Dashboard Project Page js -->
    <script src="{{asset('asdzxc/js/pages/dashboard.js')}}"></script>
    <!-- Dropzone js -->
    <script src="{{asset('asdzxc/libs/dropzone/min/dropzone.min.js')}}"></script>
    <!-- Nice Select -->
    <script src="{{asset('asdzxc/libs/nice-select2/js/nice-select2.js')}}"></script>
    <!-- Choices Demo js -->
    <script src="{{asset('asdzxc/js/pages/form-select.js')}}"></script>
     <!-- Shuffle JS -->
    <script src="{{asset('asdzxc/libs/shufflejs/shuffle.min.js')}}"></script>
    <!-- glightbox js -->
    <script src="{{asset('asdzxc/libs/glightbox/js/glightbox.min.js')}}"></script>
    <!-- Filtter Demo js -->
    <script src="{{asset('asdzxc/js/pages/gallery.js')}}"></script>
    <!-- Sweet Alerts js -->
